...
export function buildApi(ipc: IpcLike): SparkiiApi {
  ...
  return {
    ...
    listAgents: () => invoke('listAgents') as ReturnType<SparkiiApi['listAgents']>,
    probeOntologyGraph: () => invoke('probeOntologyGraph') as ReturnType<SparkiiApi['probeOntologyGraph']>,
