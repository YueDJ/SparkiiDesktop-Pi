...
describe('sparkii api shape', () => {
  it('exposes the expected method names', () => {
    const names = [
      'getLocalSubject', 'getProfile', 'chooseDocument', 'runWorkflow', 'prompt', 'listPendingApprovals', 'decideApproval', 'queryAudit', 'getSettings', 'saveSettings', 'listModels', 'testModel', 'diagnostics', 'on',
