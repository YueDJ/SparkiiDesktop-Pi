...
describe('sparkii api shape', () => {
  it('exposes the expected method names', () => {
    const names = [
      'getLocalSubject', 'chooseDocument', 'readDocumentBytes', 'runWorkflow', 'prompt', 'listPendingApprovals', 'decideApproval', 'queryAudit', 'getSettings', 'saveSettings', 'saveRagSettings', 'saveKnowledgeSettings', 'testRagConnection', 'listRagDatasets', 'getApiKey', 'listModels', 'testConnection', 'listProviders', 'diagnostics', 'on',
      ...
      'getRuntimePool', 'getDocumentParse', 'stopDocumentParse', 'releaseDocumentParse', 'cancelDocumentParseLoad', 'saveDocumentParseSettings', 'listDocumentParseModules', 'retryDocumentParse', 'importDocumentParseModule', 'downloadDocumentParseModule', 'cancelQueuedSession', 'releaseSessionSlot',
      'getPathForFile',
