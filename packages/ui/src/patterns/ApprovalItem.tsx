...
export function ApprovalItem({ summary, risk, toolName, sessionId, countdownText, onOpenDetail }: { summary: string; risk: string; toolName?: string; sessionId?: string; countdownText: ReactNode; onOpenDetail(): void }) {
  return (
